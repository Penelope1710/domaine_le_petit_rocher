 ...
 */
final class Version20240126095231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD created_by_id INT NOT NULL, DROP organizer_name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD organizer_name VARCHAR(150) NOT NULL, DROP created_by_id');
    }
}
